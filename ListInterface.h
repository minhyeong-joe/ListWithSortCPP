...
public:
   ...
   /** Displays the items in the list with its position value.
    @pre The list is not empty.
    @post The list items will be displayed to the user. */
   virtual void displayList() const = 0;

   /** Sorts the items in the list in the ascending order.
